...
%% 得到数据
vel_bs_fntsmc = state_bs_fntsmc(:, 5 : 7);
...
plot(time, vel_ref(:, 1), 'linewidth', 2, 'color', 'red');
hold on;
plot(time, vel_bs_fntsmc(:, 1) , 'linewidth', 2, 'color', 'blue');
% hold on;
...
set(gca, 'FontSize', 10);
set(gcf, 'unit', 'centimeters', 'position', [25 15 7 5]);
plot(time, vel_ref(:, 2), 'linewidth', 2, 'color', 'red');
hold on;
plot(time, vel_bs_fntsmc(:, 2) , 'linewidth', 2, 'color', 'blue');
% hold on;
...
set(gca, 'FontSize', 10);
set(gcf, 'unit', 'centimeters', 'position', [25 15 7 5]);
plot(time, vel_ref(:, 3), 'linewidth', 2, 'color', 'red');
hold on;
plot(time, vel_bs_fntsmc(:, 3) , 'linewidth', 2, 'color', 'blue');
% hold on;
